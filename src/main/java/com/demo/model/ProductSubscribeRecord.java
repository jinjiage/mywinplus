...
@Entity
public class ProductSubscribeRecord {
	...
	@Id
	@SequenceGenerator(name="product_subscribe_record",sequenceName="seq_product_subscribe_record",allocationSize=1)
	@GeneratedValue(generator="product_subscribe_record",strategy=GenerationType.SEQUENCE)
