...
<body>
	...
	<div class="box-right-main">
		...
		<form action="<%=basePath%>financeProductFunds/addFinanceProductFunds"
			method="post" id="valForm" enctype="multipart/form-data">
			<div class="tablelist">
				<!-- 表单 -->
				<div class="row bdlist">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="name" class="form-control" placeholder="请输入文本"
									type="text"> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="floor_amount" class="form-control"
									placeholder="请输入文本" type="text"> <span
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="ratio" class="form-control" placeholder="请输入文本"
									type="text"> <span style="visibility: hidden">验证提示预留位置</span>
							</div>
						</div>
			...
			<div class="row bdlist">
				<div class="col-md-12">
					...
					<div>
						<div>
							<textarea name="product_topic" id="productTopic"
								style="height: 300px;"></textarea>
						</div>
						<script type="text/javascript"> var ue = UE.getEditor('product_topic');</script>
					</div>
				</div>
			</div>
			...
			<div class="row bdlist">
				<div class="col-md-12">
					...
					<div>
						<div>
							<textarea name="product_factor" id="productFactor"
								style="height: 300px;"></textarea>
						</div>
						<script type="text/javascript"> var ue = UE.getEditor('product_factor');</script>
					</div>
				</div>
			</div>
			<!-- ===私募类=== -->
			<div class="row bdlist productStrategy">
				<div class="col-md-12">
					...
					<div>
						<div>
							<textarea name="product_strategy" id="productStrategy"
								style="height: 300px;"></textarea>
						</div>
						<script type="text/javascript"> var ue = UE.getEditor('product_strategy');</script>
					</div>
				</div>
			</div>
			...
			<div class="row bdlist product">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input name="product_manager_name" id="productManagerName1"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input name="product_manager_title" class="form-control"
								placeholder="请输入文本" type="text"> <span
								style="visibility: hidden">验证提示预留位置</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input name="product_manager_desc" class="form-control"
								placeholder="请输入文本" type="text"> <span
								style="visibility: hidden">验证提示预留位置</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div id="avatar" style="text-align: left">
								...
								<input type="hidden" name="product_manager_pic"
									id="productManagerPic" />
							</div>
			...
			<div class="row bdlist productManager">
				<div class="col-md-12">
					...
					<div>
						<div>
							<textarea name="product_manager" id="productManager"
								style="height: 300px;"></textarea>
						</div>
			...
			<div class="row bdlist">
				<div class="col-md-12">
					...
					<div>
						<div>
							<textarea name="contract" id="contract" style="height: 300px;"></textarea>
						</div>
			...
			<div class="row bdlist">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input name="bank_account" id="bankAccount" class="form-control"
								placeholder="请输入文本" type="text"> <span
								style="color: red;">例：招商银行杭州高新支行|1234 5678 1234
								123|杭州吉威投资管理有限公司</span> <span style="visibility: hidden">验证提示预留位置</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row bdlist guquan" style="display: none;">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input name="product_manager_name" id="productManagerName2"
								disabled="disabled" class="form-control" placeholder="请输入文本"
								type="text"> <span style="visibility: hidden">验证提示预留位置</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input name="invest_points" class="form-control"
								placeholder="请输入文本" disabled="disabled" type="text"> <span
								style="visibility: hidden">验证提示预留位置</span>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input name="sold_amount" class="form-control"
								placeholder="请输入文本" disabled="disabled" type="text"> <span
								style="visibility: hidden">验证提示预留位置</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input name="buyer_count" class="form-control"
								placeholder="请输入文本" disabled="disabled" type="text"> <span
								style="visibility: hidden">验证提示预留位置</span>
						</div>
					</div>
...
$(function () {
    ...
    if(type==0){
    	...
    	$("input[name='product_manager_pic']").attr("disabled",false);
