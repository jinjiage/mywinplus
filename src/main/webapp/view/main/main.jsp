...
<title>盈+后台管理中心</title>
 ...
 <%-- window.onload=function(){
	...
	<%
	Users  user1 = (Users)request.getSession().getAttribute("loginUsers");
	if(user1==null){
		response.sendRedirect(basePath+"view/main/login.jsp");
	}
	%>
					...
					<div class="top-right">
						<ul class="nav nav-pills">
							<li><p>
								...
								<p>${loginUsers.name }，系统管理员</p></li>
							<li style="width: 100px"><p>
									<a href="<%=basePath%>manage/logout"><span class="iconfont">&#xe606;</span></a>
								</p>
								<p>退出</p></li>
						</ul>
					</div>
						...
						<ul class="nav nav-pills nav-stacked">
							...
							<ul class="list-group">
								<li class="list-group-item"><a
									href="<%=basePath%>subject/sys/gushouList" target="rightkj">固收类</a></li>
								<li class="list-group-item"><a
									href="<%=basePath%>financeProductFunds/list" target="rightkj">私募/股权类</a></li>
								<li class="list-group-item"><a
							...
							<ul class="list-group">
								<li class="list-group-item"><a
									href="<%=basePath%>sysmember/index" target="rightkj"></span>账号管理</a></li>
								<li class="list-group-item"><a
									href="<%=basePath%>sysmember/financia" target="rightkj">理财师审核</a></li>
								<li class="list-group-item"><a
									href="<%=basePath%>sysmember/dahua" target="rightkj">绑卡管理</a></li>
								<li class="list-group-item"><a
									href="<%=basePath%>sysmember/payment" target="rightkj">付息计划</a></li>
								<li class="list-group-item"><a
									href="<%=basePath%>sysmember/rechargeManage" target="rightkj">充值管理</a></li>
								<li class="list-group-item"><a
									href="<%=basePath%>sysmember/withdrawManage" target="rightkj">提现管理</a></li>
								<li class="list-group-item"><a
									href="<%=basePath%>sysmember/inviteRewards" target="rightkj">邀请奖励</a></li>
							</ul>
							...
							<ul class="list-group">
								<li class="list-group-item"><a
									href="<%=basePath%>sys/userlist" target="rightkj">账户设置</a></li>
								<li class="list-group-item"><a
									href="<%=basePath%>sys/rolelist" target="rightkj">角色设置</a></li>
								<li class="list-group-item"><a
									href="<%=basePath%>sys/updatePasswdPage" target="rightkj">密码设置</a></li>
							</ul>
						</ul>
					</div>
				</div>
				<div class="col-sm-10">
					<div class="box-right">
						<iframe width="100%" id="kuangjia" name="rightkj" frameborder=0
							scrolling=auto src="<%=basePath%>view/main/sysindex.jsp"></iframe>
					</div>
				</div>
				<!-- 内容结束 -->
			</div>
